...
# === 1. Wczytanie danych ===
df = pd.read_csv("data_events/wydarzenia_cleaned.csv", sep=";", encoding="utf-8-sig", engine="python")

df = df.drop('id_strony', axis=1)
...
# Test rekomendacji
test_text = "Wystawa fotograficzna w muzeum"
kandydaty = ["#kultura", "#fotografia", "#muzeum", "#weekend", "#familia", "#a"]
print(recommend_hashtags(test_text, kandydaty, model))
